...
class InstaSubItem(scrapy.Item):
    """
...
class InstaSubFollowItem(scrapy.Item):
    """
...
class InstaSubUserItem(InstaSubItem):
    """
...
class InstaSubHashtagItem(InstaSubItem):
    """
...
class InstaSubPostItem(InstaSubItem):
    """
    Item for an Instagram hashtag.
    """
    pass
