...
class MagnitParse_:
    def __init__(self, start_url, db_client):
        ...
        self.db = db_client["gb_data_mining_february_2021"]
        self.collection = self.db["magnit_products_"]
...
if __name__ == "__main__":
    ...
    save_path = get_save_path("magnit_product_")
    db_client = pymongo.MongoClient("mongodb://localhost:27017")
    parser = MagnitParse_(url, db_client)
    parser.run()
